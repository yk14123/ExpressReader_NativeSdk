...
public class StatusBarUtil {
    ...
    private static final int FAKE_STATUS_BAR_VIEW_ID = R.id.expressreader_fake_status_bar_view;
    private static final int FAKE_TRANSLUCENT_VIEW_ID = R.id.expressreader_translucent_view;
