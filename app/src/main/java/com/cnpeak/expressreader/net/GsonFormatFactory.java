...
public class GsonFormatFactory extends Converter.Factory {
    /**
     * Create an instance using a default {@link Gson} instance for conversion. Encoding to JSON and
     * decoding from JSON (when no charset is specified by a header) will use UTF-8.
     */
    public static GsonFormatFactory create() {
     ...
     * decoding from JSON (when no charset is specified by a header) will use UTF-8.
     */
    public static GsonFormatFactory create(Gson gson) {
        return new GsonFormatFactory(gson);
    }

    private final Gson gson;

    private GsonFormatFactory(Gson gson) {
