...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    protected View mExpandLine;//分割线
    ...
    @IdRes
    private int mExpandLineId = R.id.expand_line;
    ...
    private void findViews() {
        ...
        mExpandLine = findViewById(mExpandLineId);
        ...
        switch (expandToggleType) {
            case EXPAND_INDICATOR_IMAGE_BUTTON:
                ...
                if (expandDrawable == null) {
                    expandDrawable = getDrawable(context, R.drawable.expressreader_icon_slide_down);
                }
                if (collapseDrawable == null) {
                    collapseDrawable = getDrawable(context, R.drawable.expressreader_icon_slide_down);
                }
            ...
            case EXPAND_INDICATOR_TEXT_VIEW:
                ...
                Drawable down = context.getResources().getDrawable(R.drawable.expressreader_icon_slide_down);
                Drawable up = context.getResources().getDrawable(R.drawable.expressreader_icon_slide_down);
